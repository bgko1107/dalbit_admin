    ...
    <div class="widget-content">
        ...
        <div id="div_yearStateSimpleTable">
            <table class="table table-bordered _tableHeight" data-height="23px" id="simpleDayTable">
                <colgroup>
                    <col width="6.1%"/><col width="6.1%"/><col width="6.1%"/><col width="6.1%"/><col width="6.1%"/>
                    <col width="6.1%"/><col width="6.1%"/><col width="6.1%"/><col width="6.1%"/><col width="6.1%"/>
                    <col width="6.1%"/><col width="6.1%"/><col width="6.1%"/><col width="6.1%"/><col width="6.1%"/>
                </colgroup>
                <thead>
        ...
        <div id="div_yearStateDetailTable" class="col-md-12 no-padding" style="display: none">
            <table class="table table-bordered _tableHeight yearStateTable" data-height="23px" style="width: 3770px;">
                <colgroup>
                ...
                <tr>
                    ...
                    <th class="_bgColor _fontColor" data-bgColor="#4472c4" data-fontcolor="white">랭킹</th>
                    <th colspan="5" class="_bgColor _fontColor" data-bgColor="#4472c4" data-fontcolor="white">서비스</th>
                ...
                <tr>
                    ...
                    <th rowspan="2" class="_bgColor" data-bgColor="#b4c7e7">공지 가입<br/>3일 간 미접속</th>
                    <th rowspan="2" class="_bgColor" data-bgColor="#b4c7e7">공지 가입<br/>7일 간 미접속</th>
...
<script type="text/javascript">
    ...
    function yearTableSwich(){
        ...
        if( $("#div_yearScroll").find("#bt_tableSw").html() == "전체보기"){
            $("#div_yearScroll").css('width','3800px');
...
<script type="text/x-handlebars-template" id="tmp_tableYearStateBody_detailTotal">
    <tr class="font-bold">
        ...
        <td class="_bgColor" data-bgcolor="#f2f2f2"><span class="_fontColor" data-fontcolor="#ca6927">{{addComma p20Succ}}</span><br/>({{addComma p20Fail}})<br/>({{average p20Fail p20Succ}}%)</td>
        <td class="_bgColor" data-bgcolor="#f2f2f2"><span class="_fontColor" data-fontcolor="#ca6927">{{addComma p19Succ}}</span><br/>({{addComma p19Fail}})<br/>({{average p19Fail p19Succ}}%)</td>
        <td class="_bgColor" data-bgcolor="#f2f2f2"><span class="_fontColor" data-fontcolor="#ca6927">{{addComma p49Succ}}</span><br/>({{addComma p49Fail}})<br/>({{average p49Fail p49Succ}}%)</td>
...
<script type="text/x-handlebars-template" id="tableYearStateBody_detailDetail">
    ...
    <td class="_fontColor" onmouseover="mouseover($(this));" onmouseout="mouseout($(this));" onclick="yearStateDetailPopup($(this))" data-type="25" data-startdate="{{the_date}}" data-fontcolor="{{#dalbit_if data.gb '==' 'm'}}blue{{/dalbit_if}}{{#dalbit_if data.gb '==' 'f'}}red{{/dalbit_if}}">{{#dalbit_if p25Succ '!=' 0}}<span class="font-bold">{{addComma p25Succ}}</span><br/>({{addComma p25Fail}})<br/>({{average p25Fail p25Succ}}%){{else}}{{#dalbit_if p25Fail '!=' 0}}<span class="font-bold">{{addComma p25Succ}}</span><br/>({{addComma p25Fail}})<br/>({{average p25Fail p25Succ}}%){{/dalbit_if}}{{/dalbit_if}}</td>
    ...
    <td class="_fontColor" onmouseover="mouseover($(this));" onmouseout="mouseout($(this));" onclick="yearStateDetailPopup($(this))" data-type="49" data-startdate="{{the_date}}" data-fontcolor="{{#dalbit_if data.gb '==' 'm'}}blue{{/dalbit_if}}{{#dalbit_if data.gb '==' 'f'}}red{{/dalbit_if}}">{{#dalbit_if p49Succ '!=' 0}}<span class="font-bold">{{addComma p49Succ}}</span><br/>({{addComma p49Fail}})<br/>({{average p49Fail p49Succ}}%){{else}}{{#dalbit_if p49Fail '!=' 0}}<span class="font-bold">{{addComma p49Succ}}</span><br/>({{addComma p49Fail}})<br/>({{average p49Fail p49Succ}}%){{/dalbit_if}}{{/dalbit_if}}</td>
