...
<div class="widget widget-table mb10" style="width: 2500px;">
    <div class="widget-content mt10" id="divDalAmt">
        ...
        <table class="table table-bordered">
            <colgroup>
                <col width="4%"/><col width="2.6%"/><col width="2.6%"/><col width="2.6%"/>
...
<script type="text/javascript">
    ...
    function handlebarsPaging(targetId, pagingInfo) {
        if(targetId == "dalAmt_paginate_top" || targetId == "dalAmt_paginate") {
    ...
    $('#excelDownBtn').on('click', function(){
        ...
        util.excelDownload($(this), "/rest/enter/pay/dal/amtListExcel", formData, fn_success_excel, fn_fail_excel)
    });
